...
public class SaleService {
    ...
    public List<SummaryMinDTO> findBySummary(String dataInicial, String dataFinal) {
        ...
        LocalDate dataMinima = (dataInicial == null || dataInicial.equals("")) ? dataMaxima.minusYears(3L) : LocalDate.parse(dataInicial);
    ...
    public Page<ReportMinDTO> findByReport(String dataInicial, String dataFinal, String name, Pageable pageable){
        ...
        LocalDate dataMaxima = (dataFinal == null || dataFinal.trim().isEmpty()) ? today : LocalDate.parse(dataFinal);
        LocalDate dataMinima = (dataInicial == null || dataInicial.trim().isEmpty()) ? today.minusYears(3L) : LocalDate.parse(dataInicial);
